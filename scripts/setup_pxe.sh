...
#http://ftp.mgts.by/pub/CentOS/8-stream/isos/x86_64/CentOS-Stream-8-20240318.0-x86_64-dvd1.iso
curl -O http://ftp.mgts.by/pub/CentOS/8-stream/isos/x86_64/CentOS-Stream-8-20240318.0-x86_64-dvd1.iso

# copy disk from local system 
scp -o Ciphers=aes128-gcm@openssh.com -F config ../CentOS-Stream-8-20240318.0-x86_64-boot.iso pxeserver:/mnt/extraspace/
mkdir /mnt/centos8-install
mount -t iso9660  /mnt/extraspace/CentOS-Stream-8-20240318.0-x86_64-boot.iso /mnt/centos8-install
...
#url --url=http://ftp.mgts.by/pub/CentOS/8-stream/isos/x86_64/
